...
| **Export dialog** (FR-150): `createCanvasExportPlugin` opens the full dialog (format, page scope, scale, progress, PDF fidelity note). | Dialog | Legacy `ExportMenu` popover stays exported; mount via a custom header plugin. |
